...
const NEW = [
  ...
  ['tournament_daily_second_prize', '1150', 'Bronze Cup · 2nd Prize', 'rewards'],
  ['tournament_daily_third_prize', '460', 'Bronze Cup · 3rd Prize', 'rewards'],
  ['tournament_weekly_second_prize', '5750', 'Silver Cup · 2nd Prize', 'rewards'],
  ['tournament_weekly_third_prize', '2300', 'Silver Cup · 3rd Prize', 'rewards'],
  ['tournament_champion_second_prize', '11500', 'Gold Cup · 2nd Prize', 'rewards'],
  ['tournament_champion_third_prize', '4600', 'Gold Cup · 3rd Prize', 'rewards'],
  // Tournament round-survival payouts (per current hardcoded values)
  ['tournament_daily_round4_payout', '50', 'Bronze Cup · Survive R4', 'rewards'],
  ['tournament_daily_round5_payout', '100', 'Bronze Cup · Survive R5', 'rewards'],
  ['tournament_daily_round6_payout', '250', 'Bronze Cup · Survive R6', 'rewards'],
  ['tournament_weekly_round4_payout', '250', 'Silver Cup · Survive R4', 'rewards'],
  ['tournament_weekly_round5_payout', '500', 'Silver Cup · Survive R5', 'rewards'],
  ['tournament_weekly_round6_payout', '1250', 'Silver Cup · Survive R6', 'rewards'],
  ['tournament_champion_round4_payout', '500', 'Gold Cup · Survive R4', 'rewards'],
  ['tournament_champion_round5_payout', '1000', 'Gold Cup · Survive R5', 'rewards'],
  ['tournament_champion_round6_payout', '2500', 'Gold Cup · Survive R6', 'rewards'],
