...
// POST /api/companies/:id/financials/rebuild-cashflow
// Rebuilds all cash flow statements from existing transactions
export async function POST(
  ...
  try {
    ...
    // Get all transactions that should affect cash flow
    ...
    const transactionsByPeriod = new Map<string, typeof allTransactions>();
    ...
    return NextResponse.json({ 
      success: true,
      message: `Rebuilt cash flow statements for ${periods.length} periods`,
