...
const whitepaperSchema = z.object({
  ...
  coreValues: z.any().optional().nullable(),
  ...
  // Technology
  technologyStack: z.any().optional().nullable(),
  ...
  revenueStreams: z.any().optional().nullable(),
  ...
  customerSegments: z.any().optional().nullable(),

  // Competitive Landscape
  competitiveAnalysis: z.string().optional().nullable(),
  competitors: z.any().optional().nullable(),
  competitiveAdvantage: z.string().optional().nullable(),

  // Team & Advisors
  teamDescription: z.string().optional().nullable(),
  keyTeamMembers: z.any().optional().nullable(),
  advisors: z.any().optional().nullable(),
  partners: z.any().optional().nullable(),
  ...
  fundingHistory: z.any().optional().nullable(),
  useOfFunds: z.string().optional().nullable(),
  financialHighlights: z.any().optional().nullable(),

  // Tokenomics / Economics
  tokenomics: z.string().optional().nullable(),
  tokenDistribution: z.any().optional().nullable(),
  economics: z.string().optional().nullable(),

  // Use Cases
  useCases: z.any().optional().nullable(),
  caseStudies: z.any().optional().nullable(),
  ...
  // Additional Content
  appendices: z.any().optional().nullable(),
  references: z.any().optional().nullable(),
...
export async function PUT(
  ...
  try {
    ...
    if (validated.publishedDate) {
      const d = new Date(validated.publishedDate);
      if (!isNaN(d.getTime())) publishedDate = d;
    }
    let lastReviewed: Date | null = null;
    if (validated.lastReviewed) {
      const d = new Date(validated.lastReviewed);
      if (!isNaN(d.getTime())) lastReviewed = d;
    }
