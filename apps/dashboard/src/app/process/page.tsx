        ...
        <div className="max-w-7xl mx-auto">
          <div className="relative z-10">
            <div className="text-sm uppercase tracking-widest text-blue-400 mb-6">
              {pageContent.hero?.subtitle || 'How We Work'}
            </div>
            <h1 className="text-7xl font-light leading-tight mb-8">
              {pageContent.hero?.title || 'Our Process'}
            </h1>
            <p className="text-xl text-white/70 max-w-2xl mb-10 leading-relaxed">
              {pageContent.hero?.description || 'A systematic approach to transforming ideas into intelligent systems.'}
            </p>
          </div>
        </div>
          ...
          <div className="space-y-32">
            {pageContent.sections?.map((section: any, index: number) => (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-6xl font-light text-blue-400/30 mb-4">
                    {section.step || `0${index + 1}`}
                  </div>
                  <h2 className="text-5xl font-light mb-6">{section.title || `Step ${index + 1}`}</h2>
