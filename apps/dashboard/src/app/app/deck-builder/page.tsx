                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-md text-white focus:outline-none focus:border-blue-500 placeholder:text-white/50 [.light_&]:bg-white [.light_&]:border-slate-300 [.light_&]:text-slate-900 [.light_&]:placeholder:text-slate-500"
                    />
                  </div>
                      ...
                      {editingSlide.content.map((item: string, index: number) => (
                        <div key={index} className="flex gap-2">
                          <textarea
                            ...
                            className="flex-1 px-3 py-2 bg-white/5 border border-white/10 rounded-md text-white focus:outline-none focus:border-blue-500 min-h-[80px] placeholder:text-white/50 [.light_&]:bg-white [.light_&]:border-slate-300 [.light_&]:text-slate-900 [.light_&]:placeholder:text-slate-500"
