        ...
        <div className="max-w-[1000px] mx-auto">
          {venture.websiteUrl ? (
            <a
              ...
              className="block relative rounded-2xl overflow-hidden border border-slate-700/50 bg-slate-900 aspect-video group cursor-pointer"
            >
              <WebsitePreview
              ...
              <div className="absolute bottom-4 right-4 px-4 py-2 bg-slate-900/80 backdrop-blur-sm rounded-full text-sm text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
