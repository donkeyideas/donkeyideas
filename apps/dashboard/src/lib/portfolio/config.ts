...
export const PRODUCT_CONTEXT: Record<string, ProductContext> = {
  ...
  topviso: { thesis: 'A B2B ASO/SEO SaaS sharing OpticRank\'s audience. Success = paying orgs, MRR, activation.', primaryMetric: 'revenue', domain: 'https://topviso.com' },
  goviral: { thesis: 'A B2B creator/social-analytics SaaS. Success = paying creators, MRR, platforms connected, content posted.', primaryMetric: 'revenue', domain: 'https://govirall.com' },
  buildwrk: { thesis: 'A construction-ERP SaaS — regulated, sales-led, low-volume high-value. Success = paying construction firms, contracts, demos booked, projects created.', primaryMetric: 'revenue', domain: 'https://buildwrk.com' },
  havana: { thesis: 'A local cleaning-services marketplace. Success = completed bookings, booking revenue, repeat customers. Low ceiling, cash-generating.', primaryMetric: 'bookings', domain: 'https://havanacleaning.com' },
  basktball: { thesis: 'A consumer BASKETBALL stats/predictions MOBILE APP. Traction is driven by APP DOWNLOADS and in-app engagement, NOT website signups. No revenue model yet — judge it on installs + active users, never on web signups or revenue.', primaryMetric: 'installs', domain: 'https://basktball.com' },
  cfbsocial: { thesis: 'A college-football social app (web + mobile), strongly SEASONAL (peaks into football season ~August). Success = installs + engagement. No revenue model — off-season lulls are expected, not failure.', primaryMetric: 'installs', domain: 'https://cfbsocial.com' },
  jetdale: { thesis: 'A pre-launch AI project tool. Judge on waitlist / early instrumentation, not traction it cannot have yet.', primaryMetric: 'waitlist', domain: 'https://jetdale.com' },
  julyu: { thesis: 'A pre-launch grocery price-comparison app. Judge on waitlist / signup momentum.', primaryMetric: 'waitlist', domain: 'https://julyu.com' },
  kamioi: { thesis: 'An early regulated FINTECH (round-up investing). Success = funded accounts (first transaction), demos, trust milestones — low volume, high value. Dormancy is not death for an early fintech.', primaryMetric: 'revenue', domain: 'https://kamioi.com' },
